...
exports.updateChatRequest = redux_actions_1.createAction("UPDATE_CHAT_REQUEST", function () { return ({}); });
exports.addActionRequest = redux_actions_1.createAction("ADD_ACTION_REQUEST", function (action) { return ({ action: action }); });
exports.addAction = redux_actions_1.createAction("ADD_ACTION", function () { });
